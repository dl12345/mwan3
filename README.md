...
19. [Changelog](#19-changelog)
    ...
    - 19.2 [Version 3.6.11](#192-version-3611)
    - 19.3 [Version 3.6.10](#193-version-3610)
    - 19.4 [Version 3.6.9](#194-version-369)
    - 19.5 [Version 3.6.8](#195-version-368)
    - 19.6 [Version 3.6.7](#196-version-367)
    - 19.7 [Version 3.6.6](#197-version-366)
    - 19.8 [Version 3.6.5](#198-version-365)
    - 19.9 [Version 3.6.4](#199-version-364)
    - 19.10 [Version 3.6.3](#1910-version-363)
    - 19.11 [Version 3.6.2](#1911-version-362)
    - 19.12 [Version 3.6.1](#1912-version-361)
    - 19.13 [Version 3.6](#1913-version-36)
    - 19.14 [Version 3.5.3](#1914-version-353)
    - 19.15 [Version 3.5.2](#1915-version-352)
    - 19.16 [Version 3.5.1](#1916-version-351)
    - 19.17 [Version 3.5](#1917-version-35)
    - 19.18 [Version 3.4.1 (Unreleased)](#1918-version-341-unreleased)
    - 19.19 [Version 3.4](#1919-version-34)
    - 19.20 [Version 3.3.5](#1920-version-335)
    - 19.21 [Version 3.3.4](#1921-version-334)
    - 19.22 [Version 3.3.3](#1922-version-333)
    - 19.23 [Version 3.3.2](#1923-version-332)
    - 19.24 [Version 3.3.1](#1924-version-331)
    - 19.25 [Version 3.3](#1925-version-33)
    - 19.26 [Version 3.2.3](#1926-version-323)
    - 19.27 [Version 3.2.2](#1927-version-322)
    - 19.28 [Version 3.2.1](#1928-version-321)
    - 19.29 [Version 3.2](#1929-version-32)
    - 19.30 [Version 3.1.4](#1930-version-314)
    - 19.31 [Version 3.1.3](#1931-version-313)
    - 19.32 [Version 3.1.2](#1932-version-312)
    - 19.33 [Version 3.1.1](#1933-version-311)
...
The module's public interface is declared as an export list (`export { log_open, log_verbose, log_msg, ucibool, render, cidr_split, prefix_canon, mask_cidr, aligned, prefix_overlap, prefix_contains, lease_pd_entries }`) rather than inline on each function, which this ucode build does not accept.
...
`usr/sbin/mwan3rtmon` (see [Section 7.9](#79-usrsbinmwan3rtmon)) is the ucode route-monitor daemon; one instance runs per address family (`ipv4` and `ipv6`). It mirrors kernel routing changes into mwan3's connected and custom nft sets and into the per-interface routing tables, and maintains each tracked interface's `ROUTE_STATUS` file. Shared logging (`log_open`, `log_verbose`, `log_msg`) and `ucibool` are imported from `common.uc` (Section 8.2).
...
/etc/init.d/mwan3 start
  ...
  +--> mwan3_set_general_nft()         populate hook chain rules
  +--> mwan3_set_policies_nft()        create policy chains; build IPv6 src-routing chains
  +--> mwan3_set_user_rules()          populate user rules chain
  +--> mwan3_flush_stale_conntrack()   flush zero-mark conntrack entries
...
connected action fires for $INTERFACE (link-layer negotiation complete, or tracker recovery)
  +--> 25-mwan3 hotplug script
       ...
       +--> [if ipv6_failover_type=deprecate:]
            +--> mwan3_ipv6_deprecate_lan restore       lift LAN prefix deprecation
```
...
netifd signals ifupdate for $INTERFACE (DHCPv6-PD prefix refresh)
  +--> 25-mwan3 hotplug script
       +--> [if IFUPDATE_PREFIXES=1:]
            +--> mwan3_set_src_routing_nft()            rebuild IPv6 src-routing chains
            +--> [if ipv6_failover_type=deprecate:]
                 +--> mwan3_ipv6_redeprecate_all()      re-assert preferred_lft 0 on still-down WANs
```
...
disconnected action fires for $INTERFACE (soft failure: tracker-detected, link still physically up)
  +--> 25-mwan3 hotplug script
       ...
       +--> mwan3_flush_conntrack()                       flush conntrack entries for this iface's fwmark
       +--> [if ipv6_failover_type=deprecate:]
            +--> mwan3_ipv6_deprecate_lan deprecate       deprecate downstream prefix lifetimes
```
...
### 19.18 Version 3.4.1 (Unreleased)
